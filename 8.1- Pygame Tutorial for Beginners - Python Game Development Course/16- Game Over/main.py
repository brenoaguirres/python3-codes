...
class Enemy1(pygame.sprite.Sprite):
    def __init__(self, x=32, y=32):
        ...
        # die sfx
        self.sfx = pygame.mixer.Sound('audio/expl.wav')
...
class Torpedo(pygame.sprite.Sprite):
    def __init__(self, player_rect):
        ...
        self.rect = self.image.get_rect(center=(self.x, self.y))
        self.sfx = pygame.mixer.Sound('audio/pew.wav')
...
background = pygame.image.load('images/space-bg.jpg').convert()
background = pygame.transform.smoothscale(background, (800, 600))
font = pygame.font.Font('fonts/space-xrebron.ttf', 32)
large_font = pygame.font.Font('fonts/space-xrebron.ttf', 64)
small_font = pygame.font.Font('fonts/space-xrebron.ttf', 16)
